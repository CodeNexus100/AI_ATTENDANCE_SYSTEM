...
def student_screen():
    ...
    if photo_source:
        ...
        with st.spinner('AI is scanning..'):
            ...
            if num_faces == 0:
                ...
                st.warning('Multiple faces count!')
            else:
                if detected:
    ...
    if show_registration:
        with st.container(border=True):
            ...
            # new_name = st.text_input("Enter your name", placeholder='E.g. Pooja Deshpande')
            new_name = st.text_input("Enter your name", placeholder='E.g. Kartikey Gupta')
