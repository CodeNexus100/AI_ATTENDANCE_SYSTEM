...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    # teacher_username = st.text_input("Enter username", placeholder='@pooja')
    teacher_username = st.text_input("Enter username", placeholder='@kartikey')
...
def teacher_screen_register():
    ...
    # teacher_name = st.text_input("Enter name", placeholder='Pooja')
    teacher_name = st.text_input("Enter name", placeholder='Kartikey')
